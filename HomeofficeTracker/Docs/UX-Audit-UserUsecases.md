...
**Was die App tun sollte:** Im Onboarding eine kurze Frage: „Bist du Arbeitnehmer (angestellt) oder selbstständig?" Wenn selbstständig: Klarer Hinweis, dass die Homeoffice-Pauschale für diesen Fall als Betriebsausgabe gilt, und optionale Erklärung des Unterschieds. Das klingt nach einem Conversions-Killer – ist aber das Gegenteil: Es baut massives Vertrauen auf und verhindert negative Reviews von Nutzern die die App für ihr Setup nicht verstehen.
...
- Bei „Selbstständig": Freundliche Erklärung + Hinweis auf die andere steuerliche Behandlung (Betriebsausgaben statt Werbungskosten)
...
- **Premium (2,99€/Jahr):** PDF-Export, CSV-Export, Widget, Pendelkostenrechner, mehrere Arbeitsstätten, Wochenmuster Auto-Fill
...
Ein „DACH Tax Bundle" (Homeoffice-Tracker + Pendler-Tracker) für 4,99€ statt 2×2,99€ ist ein natürlicher Upsell. Nutzer die einen Tracker kaufen, sind hoch-wahrscheinlich bereit für den zweiten.

**2. Jahreswechsel-Upgrade-Prompt:**
Zum Jahreswechsel: „2025 abgeschlossen – möchtest du eine schöne Jahresübersicht als PDF?" Wenn das ein Premium-Feature ist, ist der Prompt hochrelevant und zeitlich perfekt.
...
2. **Onboarding Eligibility-Check** – Selbstständige freundlich adressieren (Betriebsausgaben vs. Werbungskosten)
...
9. **iCloud-Backup-Hinweis in Settings** – Verhindert Datenverlust-Panik und 1-Stern-Reviews
10. **App-Store-Beschreibung jährlich aktualisieren** – Rechtslage und Beträge müssen stimmen

---

*Kanonischer Pfad: `Docs/UX-Audit-UserUsecases.md` | Nächste Review: Januar 2027 (nach Gesetzesänderungen prüfen)*
